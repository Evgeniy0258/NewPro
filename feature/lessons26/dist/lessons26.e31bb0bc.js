...
exports.wrapperRow = exports.deleteAllButton = exports.bigWrapper = exports.addTodoTextField = exports.addTodoButton = void 0;
var bigWrapper = document.createElement('div');
exports.bigWrapper = bigWrapper;
...
exports.deleteAllButton = deleteAllButton;
deleteAllButton.textContent = 'Delete All';
deleteAllButton.classList.add('btn');
var addTodoTextField = document.createElement('input');
exports.addTodoTextField = addTodoTextField;
...
exports.deleteAll = exports.createTodo = void 0;
...
function getTodo(text) {
  ...
  todoElement.setAttribute('id', "todo-".concat(Math.floor(Math.random() * 1000) + 1));
  ...
  todoTextElement.classList.add('todo-text'); // todoTextElement.innerHTML = `<span>${text}<span>`
  ...
  var todoDatetimeBox = document.createElement('span');
...
var createTodo = function createTodo() {
  var text = _components.addTodoTextField.value;

  _components.bigWrapper.append(getTodo(text));

  _components.addTodoTextField.value = '';
};
...
},{"./components.js":"components.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
_components.wrapperRow.append(_components.deleteAllButton, _components.addTodoTextField, _components.addTodoButton);

_components.bigWrapper.append(_components.wrapperRow);

root.append(_components.bigWrapper);

_components.addTodoButton.addEventListener('click', _function.createTodo);

_components.deleteAllButton.addEventListener('click', _function.deleteAll); // ----------------- Render section -----------------
// let todos = TodoController.generateTodos(2);
},{"./components.js":"components.js","./function.js":"function.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
